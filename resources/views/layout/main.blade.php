        ...
        <div class="body-main h-100">
            <div class="row g-0 h-100">
                <div class="col-sm-2 sidebar collapse d-lg-block" id="navbarSupportedContent">
                    <a href="/rental" @if (request()->route()->uri == 'rental') class= 'active' @endif><i
                            class="bi bi-house-check-fill"></i> Dashboard</a>
                    <a href="/rental/trash/all" @if (request()->route()->uri == 'rental/trash/all') class= 'active' @endif><i
                            class="bi bi-card-checklist"></i> SoftDeletes</a>
                </div>
